/**
 * Tela excluir, permite que o usuario faça uma busca da peça pelo
 * codigo (numero) e traga todas as informações da peça, caso seja
 * a peça procurada o usuario terá a opção de apagá-la.
 */
...
public class SipExclusao extends JFrame {
  ...
  private void iniciar() throws Exception {
    ...
    // Adiciona o evento no botão excluir
  ...
  /**
   * Função do botão excluir, depois do usuario ter procurado a peça a ser excluida
   * o botão de excluir será habilidado, caso o usuario excluir a peça, se for 
   * excluido com sucesso ou não, aparecerá uma mensagem na tela para o usuario.
   * @param e
   */
